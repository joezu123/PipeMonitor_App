...
unsigned char guc_RTURecvArr[100] = {0};	//Modbus RTU接收数据缓存
...
SysDeviceParaSt gs_DeviceDefaultPara = 
{
	...
	{'2','5','-','1','1','-','0','6'},	//char cDevicePDDate[10];		//设备生产日期: YY-MM-DD
	...
	{0},						//char cPlanEnableFlag;	//预案功能开关：0->未启用；1->启用
	{0},						//char cAlarmEnableFlag;	//设备预警功能开关：0->未启用；1->启用
