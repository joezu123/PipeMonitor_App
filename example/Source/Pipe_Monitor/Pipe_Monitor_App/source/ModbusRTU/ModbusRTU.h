...
#define MB_W_DEVICE_FACTORY_RESET_CMD     			(MB_DEVICE_PARA_BASE + 0x006E) //设备恢复出厂设置命令寄存器地址
...
#define MB_R_DEVICE_FLOWERMETER_SENSOR_VALUE 		(MB_DEVICE_PARA_BASE + 0x0074) //截污流量计传感器值寄存器地址--瞬时流量
#define MB_R_DEVICE_INTEGRATED_CONDUCTIVITY_SENSOR_VALUE (MB_DEVICE_PARA_BASE + 0x0076) //一体式数字电导率传感器值寄存器地址
#define MB_R_DEVICE_FLOWERSPEED_SENSOR_VALUE    	(MB_DEVICE_PARA_BASE + 0x0078)	//流量计-流速
#define MB_R_DEVICE_FLOWERMETER_TOTAL_SENSOR_VALUE	(MB_DEVICE_PARA_BASE + 0x007A)	//流量计-累计流量
